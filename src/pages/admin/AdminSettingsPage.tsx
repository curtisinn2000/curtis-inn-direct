    ...
    <div>
      ...
      <Tabs defaultValue="profile">
        ...
        <TabsContent value="clover">
          <Card className="p-6 space-y-4 max-w-lg">
            <p className="text-sm text-muted-foreground">Clover payment integration settings.</p>
            <div><Label>Clover Merchant ID</Label><Input placeholder="Enter Merchant ID" /></div>
            <div><Label>API Key</Label><Input type="password" placeholder="Enter API Key" /></div>
            <div><Label>Environment</Label><Input defaultValue="Sandbox" /></div>
            <Badge variant="secondary">Placeholder — configure via backend</Badge>
            <Button>Save Settings</Button>
          </Card>
        </TabsContent>
